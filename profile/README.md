...
| ------------- | ------------- |
| Developers embed the VCS into their application to allow users to select and retrieve Verifiable Credentials (VCs) Project Lead: @jacksophtron | Connects the lender and borrower to exchange money securely. Here group of participants that are exchanging data and services are using a free and open source protocol. To know more head over to our [Getting Started](https://photos.onedrive.com/share/177DEE71378DB3AD!9886?cid=177DEE71378DB3AD&resId=177DEE71378DB3AD!9886&authkey=!APppAVFUzYZ2LIY&ithint=video&e=fddgt9)| 
